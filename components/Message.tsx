...
export default function Message({ message }: MessageProps) {
  ...
  if (message.messageDeleted === false) {
    return (
      <div className="wmessage hmessage p-6 border rounded-lg shadow gap-2 bg-stone-300">
        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col px-1">
            <button
              ...
              className="hidden border shadow font-bold pr-2 py-1 px-7 my-2 rounded-lg bg-stone-200 hover:bg-stone-400"
            >
              <img
                src="/images/icon.png"
                alt="icon"
            ...
            <input
              type="password"
              ref={textRef}
              className="hidden border shadow px-1 rounded-lg w-20"
            />
          </div>
        </div>
      </div>
